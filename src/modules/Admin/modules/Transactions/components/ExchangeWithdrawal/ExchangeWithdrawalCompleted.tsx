...
class ExchangeWithdrawalCompleted extends React.Component {
  ...
  render() {
    ...
    const filters : IInTransactionsFiltersDTO =
      { type: TransactionType.ExchangeWithdrawal, status: TransactionStatus.Completed };
...
export default ExchangeWithdrawalCompleted;
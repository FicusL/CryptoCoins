...
class ExchangeWithdrawalRejected extends React.Component {
  ...
  render() {
    ...
    const filters : IInTransactionsFiltersDTO =
      { type: TransactionType.ExchangeWithdrawal, status: TransactionStatus.Rejected };
...
export default ExchangeWithdrawalRejected;